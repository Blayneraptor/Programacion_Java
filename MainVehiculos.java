...
public class MainVehiculos {public static void main(String[] args) {
   ...
   for (Vehiculo vehiculo : vehiculosArray) {
       ...
       if (vehiculo instanceof Turismo) {
           ...
           System.out.println("Número de plazas: " + turismo.getNumPlazas());
